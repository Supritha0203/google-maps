...
const List<String> _supportedLanguages = ['en', 'hi', 'mr', 'pa', 'te'];
...
class GlobalTranslations {
  ...
  String text(String? key) {
    // Return the requested string                                       // '** $key not found'
  ...
  Future<void> setNewLanguage(
    ...
    _locale = Locale(language!, "IN");
    //  print("languageCode: "+_locale.languageCode);
